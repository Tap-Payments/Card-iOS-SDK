...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/SharedDataModels-iOS/SharedDataModels_iOS.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TapCardScannerWebWrapper-iOS/TapCardScannerWebWrapper_iOS.framework"

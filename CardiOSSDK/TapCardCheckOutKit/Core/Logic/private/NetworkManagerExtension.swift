...
"""
    ...
    static var staticHTTPHeaders: [String: String] {
        ...
        var result = [
            ...
            Constants.HTTPHeaderKey.mdn: Crypter.encrypt("company.tap.goSellSDKExamplee", using: NetworkManager.headersEncryptionPublicKey) ?? ""
        ]
        ...
        if let middleWareToken = sharedNetworkManager.dataConfig.initModelResponse?.session {
    ...
    struct Constants {
        ...
        fileprivate struct HTTPHeaderValueKey {
            ...
            fileprivate static let requirerValue            = "iOS-card-sdk"
